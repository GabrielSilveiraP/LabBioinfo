o q tu fez com o rtracklayer e o q importou com o 
makeTxDbFromGFF meio q serve pra mesma coisa
...
diretorio_base <-"c/UFSC/LabInfo/prepDE/"
...
gtf_file <- "C:\UFSC\LabInfo\prepDE\Cerebral_VS_AdiposoSALMON"
